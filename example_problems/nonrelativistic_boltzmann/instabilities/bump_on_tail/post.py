...
pl.plot(time_array_1, E_nls_tau_inf, color = 'C0', label=r'$\tau=\inf$')
pl.plot(time_array_1, E_ls_tau_inf, '--', color = 'C0', label = r'$\tau=\inf$')
pl.plot(time_array_2, E_nls_tau_100, color = 'C1', label=r'$\tau=100$')
pl.plot(time_array_2, E_ls_tau_100, '--', color = 'C1', label = r'$\tau=100$')
pl.plot(time_array_3, E_nls_tau_10, color = 'C2', label=r'$\tau=10$')
pl.plot(time_array_3, E_ls_tau_10, '--', color = 'C2', label = r'$\tau=10$')
pl.plot(time_array_4, E_nls_tau_1, color = 'C3', label=r'$\tau=1$')
pl.plot(time_array_4, E_ls_tau_1, '--', color = 'C3', label = r'$\tau=1$')
pl.plot(time_array_5, E_nls_tau_1e_minus_2, color = 'C4', label=r'$\tau=0.01$')
pl.plot(time_array_5, E_ls_tau_1e_minus_2, '--', color = 'C4', label = r'$\tau=0.01$')
pl.plot(time_array_6, E_nls_tau_1e_minus_3, color = 'C5', label=r'$\tau=0.001$')
pl.plot(time_array_6, E_ls_tau_1e_minus_3, '--', color = 'C5', label = r'$\tau=0.001$')
...
pl.semilogy(time_array_1, E_nls_tau_inf, color = 'C0', label=r'$\tau=\inf$')
