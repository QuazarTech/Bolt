...
print(kinetic_energy_error[0])
print(electric_energy_error[0])
print(magnetic_energy_error[0])

pl.semilogy(time_array / params.t0, abs(kinetic_energy_error), label = r'$|$KE(t) - KE(t = 0)$|$')
