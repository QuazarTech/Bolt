...
# (delta_u2_e, ' = ', 8.049116928532385e-16 + 0.2722586144213775*I)
# (delta_u3_e, ' = ', 0.2722586144213809 + 6.106226635438361e-16*I)
# (delta_u2_i, ' = ', 4.163336342344337e-16 + 0.45462729344290764*I)
# (delta_u3_i, ' = ', 0.4546272934429093)
# (delta_B2, ' = ', -8.881784197001252e-16 - 0.3732927644717018*I)
# (delta_B3, ' = ', -0.3732927644717047 - 1.3877787807814457e-16*I)
# (delta_E2, ' = ', -0.2825628831308188 - 4.718447854656915e-16*I)
# (delta_E3, ' = ', 9.159339953157541e-16 + 0.28256288313081546*I)
...
def initialize_B(q1, q2, params):
    ...
    omega = 2.181414783511122e-16 - 0.378473560197061 * 1j

    B2 = (params.amplitude * (-8.881784197001252e-16 - 0.3732927644717018*1j) * \
          np.exp(  1j * params.k_q1 * np.array(q1)
                 + omega * dt / 2
                )).real

    B3 = (params.amplitude * (-0.3732927644717047 - 1.3877787807814457e-16*1j) * \
          np.exp(  1j * params.k_q1 * np.array(q1)
                 + omega * dt / 2
                )).real
