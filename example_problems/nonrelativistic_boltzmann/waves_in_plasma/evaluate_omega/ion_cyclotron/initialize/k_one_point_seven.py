...
# (delta_u2_e, ' = ', -1.0408340855860843e-16 + 0.12469400261480595*I)
# (delta_u3_e, ' = ', 0.12469400261480666 - 8.326672684688674e-17*I)
# (delta_u2_i, ' = ', -2.498001805406602e-16 + 0.6172431505784929*I)
# (delta_u3_i, ' = ', 0.6172431505784938)
# (delta_B2, ' = ', 1.1102230246251565e-16 - 0.29220919614875873*I)
# (delta_B3, ' = ', -0.2922091961487587)
# (delta_E2, ' = ', -0.13444732969430967 + 8.326672684688674e-17*I)
# (delta_E3, ' = ', 5.551115123125783e-17 + 0.1344473296943089*I)
...
def initialize_f(q1, q2, v1, v2, v3, params):
    ...
    v2_bulk_i =   params.amplitude * -5.745404152435185e-15 * af.cos(params.k_q1 * q1) \
                - params.amplitude * 0.6172431505784929 * af.sin(params.k_q1 * q1)

    v2_bulk_e =   params.amplitude * -5.88418203051333e-15 * af.cos(params.k_q1 * q1) \
                - params.amplitude * 0.12469400261480595 * af.sin(params.k_q1 * q1)
    
    v3_bulk_i =   params.amplitude * 0.6172431505784938 * af.cos(params.k_q1 * q1) \
                - params.amplitude * 2.220446049250313e-16  * af.sin(params.k_q1 * q1)

    v3_bulk_e =   params.amplitude * 0.12469400261480666 * af.cos(params.k_q1 * q1) \
...
def initialize_B(q1, q2, params):
    ...
    omega = -2.145963578826118e-16 - 0.7821809289122083 * 1j

    B2 = (params.amplitude * (1.1102230246251565e-16 - 0.29220919614875873*1j) * \
          np.exp(  1j * params.k_q1 * np.array(q1)
                 + omega * dt / 2
                )).real

    B3 = (params.amplitude * (-0.2922091961487587 - 5.434563389583591e-17*1j) * \
          np.exp(  1j * params.k_q1 * np.array(q1)
                 + omega * dt / 2
                )).real
