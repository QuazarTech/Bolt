...
if (params.restart):
    ...
    params.mu = params.global_chem_potential + params.charge[0]*params.phi
    params.mu_analytic = params.global_chem_potential + params.charge[0]*params.phi
...
#                    )
    ...
    mean_density = af.mean(density[0, 0, N_g:-N_g, N_g:-N_g])
    density_pert = density - mean_density
    
#    if (time_step%1==0):
#        chemical_potential =  np.array(params.mu)[0, :, :] \
#                            - params.charge*np.array(params.phi)[:, :]
