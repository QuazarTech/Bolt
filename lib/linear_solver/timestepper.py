...
def RK6_step(self, dt):
    ...
    k4 = self._dY_dt(self.Y + (12 / 2197) *
                     (161 * k1 - 600 * k2 + 608 * k3) * dt)
    k5 = self._dY_dt(self.Y + (1 / 4104) * (8341 * k1 -
                                            32832 * k2 +
                                            29440 * k3 -
                                            845 * k4) * dt)
    k6 = self._dY_dt(self.Y + (-(8 / 27) * k1 + 2 * k2 - (3544 / 2565) * k3 +
                               (1859 / 4104) * k4 - (11 / 40) * k5) * dt)

    self.Y = self.Y + 1 / 5 * ((16 / 27) * k1 + (6656 / 2565) *
                               k3 + (28561 / 11286) * k4 - (9 / 10) * k5 +
                               (2 / 11) * k6) * dt
