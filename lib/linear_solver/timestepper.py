...
def RK6_step(self, dt):
  ...
  k3 = self.dY_dt(self.Y + (3/32)*(k1+3*k2)*dt)
  k4 = self.dY_dt(self.Y + (12/2197)*(161*k1-600*k2+608*k3)*dt)
  k5 = self.dY_dt(self.Y + (1/4104)*(8341*k1-32832*k2+29440*k3-845*k4)*dt)
  k6 = self.dY_dt(self.Y + (-(8/27)*k1+2*k2-(3544/2565)*k3+(1859/4104)*k4-(11/40)*k5)*dt)
...
def RK4_step(self, dt):
  ...
  k3 = self.dY_dt(self.Y + 0.5*k2*dt)
