...
class nonlinear_solver(object):
  def __init__(self, physical_system):
    ...
    # Creation of local and global vectors for the fields DA:
    ...
    self._A_q1 = self.physical_system.A_q1()
    self._A_q2 = self.physical_system.A_q2()
  ...
  def _time_step(self, dt):
    ...
    self.f = self._f_interp_2d(self, 0.25*dt)
