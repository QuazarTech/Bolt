...
def dY_dt(self, Y):
    ...
    ------
      ...
      Y  : The array Y is the state of the system as given by the result of
           the last time-step's integration. Y is declared as a 4D array
    ...
    C_f_hat = 2 * af.fft2(self._source_or_sink(self.f,
                                               self.q1_center,
                                               self.q2_center,
                                               self.p1,
                                               self.p2,
    ...
    mom_bulk_p1 = af.tile(self.compute_moments('mom_p1_bulk'),
                          1, 1, self.f.shape[2])
    mom_bulk_p2 = af.tile(self.compute_moments('mom_p2_bulk'),
                          1, 1, self.f.shape[2])
    mom_bulk_p3 = af.tile(self.compute_moments('mom_p3_bulk'),
                          1, 1, self.f.shape[2])
