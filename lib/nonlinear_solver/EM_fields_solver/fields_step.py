...
def fields_step(self, dt):
    ...
    if (self.physical_system.params.fields_solver == 'fft'):
        ...
        # Will returned a flattened array containing the values of J1,2,3 in 2D
        # space:
        ...
        self.J3 = 0.25 * (self.J3 + af.shift(self.J3, 1, 0) + af.shift(
            self.J3, 0, 1) + af.shift(self.J3, 1, 1))  # (i, j)
        ...
        raise NotImplementedError(
            'The method specified is invalid/not-implemented')
