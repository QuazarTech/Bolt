...
def fdtd_grid_to_ck_grid(self):
  ...
  self.E1 = 0.5 * (self.E1_fdtd + af.shift(self.E1_fdtd,  0, -1)) #(i + 1/2, j + 1/2)
  self.B1 = 0.5 * (self.B1_fdtd + af.shift(self.B1_fdtd, -1,  0)) #(i + 1/2, j + 1/2)

  self.E2 = 0.5 * (self.E2_fdtd + af.shift(self.E2_fdtd, -1,  0)) #(i + 1/2, j + 1/2)
  self.B2 = 0.5 * (self.B2_fdtd + af.shift(self.B2_fdtd,  0, -1)) #(i + 1/2, j + 1/2)

  self.E3 = 0.25 * (
                    self.E3_fdtd                  + af.shift(self.E3_fdtd,  0, -1) + \
                    af.shift(self.E3_fdtd, -1, 0) + af.shift(self.E3_fdtd, -1, -1)
                   ) #(i + 1/2, j + 1/2)
