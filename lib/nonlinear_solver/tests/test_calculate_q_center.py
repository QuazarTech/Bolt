...
def test_calculate_q():
  ...
  q1_expected = obj.q1_start + (0.5 + np.arange(-obj.N_ghost, obj.N_q1 + obj.N_ghost)) * obj.dq1
  q2_expected = obj.q2_start + (0.5 + np.arange(-obj.N_ghost, obj.N_q2 + obj.N_ghost)) * obj.dq2

  q1_expected = af.tile(af.to_array(q1_expected), 1, obj.N_q2 + 2*obj.N_ghost,\
                        obj.N_p1 * obj.N_p2 * obj.N_p3
                       )

  q2_expected = af.tile(af.reorder(af.to_array(q2_expected)), obj.N_q1 + 2*obj.N_ghost,\
                        1, obj.N_p1 * obj.N_p2 * obj.N_p3
                       )
