...
import linear_solver.initialize
...
def BGK_collision_operator(config, delta_f_hat):
  ...
  normalization = linear_solver.initialize.f_background(config, 1)

  delta_rho_hat = linear_solver.compute_moments.delta_rho_hat(config, delta_f_hat)
  delta_v_x_hat = linear_solver.compute_moments.delta_vel_bulk_x_hat(config, delta_f_hat)
  delta_v_y_hat = linear_solver.compute_moments.delta_vel_bulk_y_hat(config, delta_f_hat)
  delta_v_z_hat = linear_solver.compute_moments.delta_vel_bulk_z_hat(config, delta_f_hat)
  delta_T_hat   = linear_solver.compute_moments.delta_T_hat(config, delta_f_hat)
