...
def apply_bcs_f(self):
    ...
    if(self.physical_system.boundary_conditions.in_q1 == 'dirichlet'):
        ...
        # When _A_q1 is of shape (1, 1, Np1 * Np2 * Np3)
        ...
        if(i_q1_end == self.N_q1 - 1):
            ...
            self.f[-N_g:] = af.flip(self.f[-2 * N_g:-N_g], 0)
    ...
    if(self.physical_system.boundary_conditions.in_q2 == 'dirichlet'):
        ...
        # When _A_q2 is of shape (1, 1, Np1 * Np2 * Np3)
        # We tile to get it to form (Nq1, Nq2, Np1 * Np2 * Np3)
        if(self._A_q1.shape[0] == 1):
...
def apply_bcs_fields(self):
    ...
    if(self.physical_system.boundary_conditions.in_q1 == 'dirichlet'):
        ...
        if(i_q1_start == 0):
            ...
            self.E1[:N_g] = self.physical_system.boundary.E1_left(self.q1, self.q2,
                                                                  self.physical_system.params
                                                                 )[:N_g]
            self.E2[:N_g] = self.physical_system.boundary.E2_left(self.q1, self.q2,
                                                                  self.physical_system.params
                                                                 )[:N_g]
            self.E3[:N_g] = self.physical_system.boundary.E3_left(self.q1, self.q2,
                                                                  self.physical_system.params
                                                                 )[:N_g]
            
            self.B1[:N_g] = self.physical_system.boundary.B1_left(self.q1, self.q2,
                                                                  self.physical_system.params
                                                                 )[:N_g]
            self.B2[:N_g] = self.physical_system.boundary.B2_left(self.q1, self.q2,
                                                                  self.physical_system.params
                                                                 )[:N_g]
            self.B3[:N_g] = self.physical_system.boundary.B3_left(self.q1, self.q2,
                                                                  self.physical_system.params
                                                                 )[:N_g]
        ...
        if(i_q1_end == self.N_q1 - 1):
            ...
            self.E1[-N_g:] = self.physical_system.boundary.E1_right(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[-N_g:]
            self.E2[-N_g:] = self.physical_system.boundary.E2_right(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[-N_g:]
            self.E3[-N_g:] = self.physical_system.boundary.E3_right(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[-N_g:]
            
            self.B1[-N_g:] = self.physical_system.boundary.B1_right(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[-N_g:]
            self.B2[-N_g:] = self.physical_system.boundary.B2_right(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[-N_g:]
            self.B3[-N_g:] = self.physical_system.boundary.B3_right(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[-N_g:]
        ...
        if(i_q1_start == 0):
            ...
            self.E1[:N_g] = af.flip(self.E1[N_g:2 * N_g], 0)
            self.E2[:N_g] = af.flip(self.E2[N_g:2 * N_g], 0)
            self.E3[:N_g] = af.flip(self.E3[N_g:2 * N_g], 0)
            
            self.B1[:N_g] = af.flip(self.B1[N_g:2 * N_g], 0)
            self.B2[:N_g] = af.flip(self.B2[N_g:2 * N_g], 0)
            self.B3[:N_g] = af.flip(self.B3[N_g:2 * N_g], 0)
        ...
        if(i_q1_end == self.N_q1 - 1):
            ...
            self.E1[-N_g:] = af.flip(self.E1[-2 * N_g:-N_g], 0)
            self.E2[-N_g:] = af.flip(self.E2[-2 * N_g:-N_g], 0)
            self.E3[-N_g:] = af.flip(self.E3[-2 * N_g:-N_g], 0)

            self.B1[-N_g:] = af.flip(self.B1[-2 * N_g:-N_g], 0)
            self.B2[-N_g:] = af.flip(self.B2[-2 * N_g:-N_g], 0)
            self.B3[-N_g:] = af.flip(self.B3[-2 * N_g:-N_g], 0)
    ...
    if(self.physical_system.boundary_conditions.in_q2 == 'dirichlet'):
        ...
        if(i_q2_start == 0):
            ...
            self.E1[:, :N_g] = self.physical_system.boundary.E1_bot(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[:, :N_g]
            self.E2[:, :N_g] = self.physical_system.boundary.E2_bot(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[:, :N_g]
            self.E3[:, :N_g] = self.physical_system.boundary.E3_bot(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[:, :N_g]
            
            self.B1[:, :N_g] = self.physical_system.boundary.B1_bot(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[:, :N_g]
            self.B2[:, :N_g] = self.physical_system.boundary.B2_bot(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[:, :N_g]
            self.B3[:, :N_g] = self.physical_system.boundary.B3_bot(self.q1, self.q2,
                                                                    self.physical_system.params
                                                                   )[:, :N_g]
        ...
        if(i_q2_end == self.N_q2 - 1):
            ...
            self.E1[:, -N_g:] = self.physical_system.boundary.E1_top(self.q1, self.q2,
                                                                     self.physical_system.params
                                                                    )[:, -N_g:]
            self.E2[:, -N_g:] = self.physical_system.boundary.E2_top(self.q1, self.q2,
                                                                     self.physical_system.params
                                                                    )[:, -N_g:]
            self.E3[:, -N_g:] = self.physical_system.boundary.E3_top(self.q1, self.q2,
                                                                     self.physical_system.params
                                                                    )[:, -N_g:]
            
            self.B1[:, -N_g:] = self.physical_system.boundary.B1_top(self.q1, self.q2,
                                                                     self.physical_system.params
                                                                    )[:, -N_g:]
            self.B2[:, -N_g:] = self.physical_system.boundary.B2_top(self.q1, self.q2,
                                                                     self.physical_system.params
                                                                    )[:, -N_g:]
            self.B3[:, -N_g:] = self.physical_system.boundary.B3_top(self.q1, self.q2,
                                                                     self.physical_system.params
                                                                    )[:, -N_g:]
    ...
    af.eval(self.E1, self.E2, self.E3, 
